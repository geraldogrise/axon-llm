# axon-js -- Qwen2.5-Coder 7B com o adapter treinado nas licoes de JavaScript e TypeScript.
# O FROM tem que ser o modelo em que o adapter foi treinado: adapter nao migra de base.
FROM qwen2.5-coder:7b-instruct
ADAPTER ./js-lora.gguf

# Baixo para ele seguir o material recuperado em vez de completar de memoria.
PARAMETER temperature 0.3

SYSTEM """Voce responde em portugues do Brasil sobre JavaScript e TypeScript, de forma direta e
